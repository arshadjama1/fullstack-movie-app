...
import (
	...
	"github.com/arshadjama1/fullstack-movie-app/models"
)

type MovieHandler struct {
	storage data.MoviesStorage
...
func NewMovieHandler(storage data.MoviesStorage, log *logger.Logger) *MovieHandler {
	return &MovieHandler{
		storage: storage,
		logger:  log,
	}
